...
testa(gera_html_botao, simples, "simples_Cadastrar", True, "Cadastrar", 'solicitar_form_de_cadastrar_usuario', None, '#60a3bc')
...
testa(gera_html_botao, submit, "submit_Cadastrar", True, "Cadastrar", 'cadastrar_usuario', None, '#55ee55')

testa(gera_html_botao, submit, "submit_Alterar_usuario", True, "Alterar", 'alterar_usuario', {'id_usuario': "U-00000001"}, '#55ee55')
