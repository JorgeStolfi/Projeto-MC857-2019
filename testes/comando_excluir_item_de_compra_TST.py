...
from comando_excluir_item_de_compra import processa
import base_sql
import tabelas
import usuario
import produto
...
def testa(nome, funcao, *args):
  ...
  em "testes/saida/comando_excluir_item_de_compra.{nome}.html"."""
  
  prefixo = "testes/saida/comando_excluir_item_de_compra"
