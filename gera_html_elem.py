...
def botao_cadastrar():
  ...
  return gera_html_elem_IMP.botao_cadastrar()
...
def botao_subm_cadastrar(texto,fam_fonte,tam_fonte,pad,haling,cor_texto,cor_fundo):
    ...
    CSS (por exemplo, '#ff8800').
    """
    return gera_html_elem_IMP.botao_subm_cadastrar(texto,fam_fonte,tam_fonte,pad,haling,cor_texto,cor_fundo);
