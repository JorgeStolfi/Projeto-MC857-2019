...
def estoque_de_produto():
  """Retorna HTML de um formulario para busca de estoque de produtos.
  O formulário contém um campo editável onde o usuário entra com um valor de estoque a ser procurado, e um botão de 'Estoque'
  que solicita a busca ao servidor."""
  return gera_html_form_IMP.estoque_de_produto()
